...
cmds = [
  ...
  Command(0x0F, "loadpointer %d %#x", "bank dword", "_loadpointer"),
  ...
  Command(0x67, "preparemsg %#x", "ptr/bank0", "_preparemsg"),
  ...
  Command(0x7A, "", ""),
  Command(0x7B, "", ""),
  Command(0x7C, "checkattack %#x", "word", "_checkattack"),
  ...
  Command(0x85, "bufferstring %d 0x%08x", "buffer ptr", "_bufferstring"),

...
class MvtAction:
    def __init__(self, opcode, name, dx=0, dy=0):
        self.opcode = opcode
        self.name = name
        self.dx = dx
        self.dy = dy
...
mvt_actions = [
    MvtAction(0x0, "face_down"),
    MvtAction(0x1, "face_up"),
    MvtAction(0x2, "face_left"),
    MvtAction(0x3, "face_right"),
    MvtAction(0x4, "face_down_fast"),
    MvtAction(0x5, "face_up_fast"),
    MvtAction(0x6, "face_left_fast"),
    MvtAction(0x7, "face_right_fast"),
    MvtAction(0x8, "walk_slower_down", dy=1),
    MvtAction(0x9, "walk_slower_up", dy=-1),
    MvtAction(0xA, "walk_slower_left", dx=-1),
    MvtAction(0xB, "walk_slower_right", dx=1),
    MvtAction(0xC, "walk_slow_down", dy=1),
    MvtAction(0xD, "walk_slow_up", dy=-1),
    MvtAction(0xE, "walk_slow_left", dx=-1),
    MvtAction(0xF, "walk_slow_right", dx=1),
    MvtAction(0x10, "walk_normal_down", dy=1),
    MvtAction(0x11, "walk_normal_up", dy=-1),
    MvtAction(0x12, "walk_normal_left", dx=-1),
    MvtAction(0x13, "walk_normal_right", dx=1),
    MvtAction(0x14, "jump_2_down", dy=2),
    MvtAction(0x15, "jump_2_up", dy=-2),
    MvtAction(0x16, "jump_2_left", dx=-2),
    MvtAction(0x17, "jump_2_right", dx=2),
    MvtAction(0x18, "delay_1"),
    MvtAction(0x19, "delay_2"),
    MvtAction(0x1A, "delay_4"),
    MvtAction(0x1B, "delay_8"),
    MvtAction(0x1C, "delay_16"),
    MvtAction(0x1D, "walk_fast_down", dy=1),
    MvtAction(0x1E, "walk_fast_up", dy=-1),
    MvtAction(0x1F, "walk_fast_left", dx=-1),
    MvtAction(0x20, "walk_fast_right", dx=1),
    MvtAction(0x21, "walk_in_place_slow_down"),
    MvtAction(0x22, "walk_in_place_slow_up"),
    MvtAction(0x23, "walk_in_place_slow_left"),
    MvtAction(0x24, "walk_in_place_slow_right"),
    MvtAction(0x25, "walk_in_place_normal_down"),
    MvtAction(0x26, "walk_in_place_normal_up"),
    MvtAction(0x27, "walk_in_place_normal_left"),
    MvtAction(0x28, "walk_in_place_normal_right"),
    MvtAction(0x29, "walk_in_place_fast_down"),
    MvtAction(0x2A, "walk_in_place_fast_up"),
    MvtAction(0x2B, "walk_in_place_fast_left"),
    MvtAction(0x2C, "walk_in_place_fast_right"),
    MvtAction(0x2D, "walk_in_place_faster_down"),
    MvtAction(0x2E, "walk_in_place_faster_up"),
    MvtAction(0x2F, "walk_in_place_faster_left"),
    MvtAction(0x30, "walk_in_place_faster_right"),
    MvtAction(0x31, "ride_water_current_down", dy=1),
    MvtAction(0x32, "ride_water_current_up", dy=-1),
    MvtAction(0x33, "ride_water_current_left", dx=-1),
    MvtAction(0x34, "ride_water_current_right", dx=1),
    MvtAction(0x35, "walk_faster_down", dy=1),
    MvtAction(0x36, "walk_faster_up", dy=-1),
    MvtAction(0x37, "walk_faster_left", dx=-1),
    MvtAction(0x38, "walk_faster_right", dx=1),
    MvtAction(0x39, "slide_down", dy=1),
    MvtAction(0x3A, "slide_up", dy=-1),
    MvtAction(0x3B, "slide_left", dx=-1),
    MvtAction(0x3C, "slide_right", dx=1),
    MvtAction(0x3D, "player_run_down", dy=1),
    MvtAction(0x3E, "player_run_up", dy=-1),
    MvtAction(0x3F, "player_run_left", dx=-1),
    MvtAction(0x40, "player_run_right", dx=1),
    MvtAction(0x41, "player_run_down_slow", dy=1),
    MvtAction(0x42, "player_run_up_slow", dy=-1),
    MvtAction(0x43, "player_run_left_slow", dx=-1),
    MvtAction(0x44, "player_run_right_slow", dx=1),
    MvtAction(0x45, "start_anim_in_direction"),
    MvtAction(0x46, "jump_special_down", dy=1),
    MvtAction(0x47, "jump_special_up", dy=-1),
    MvtAction(0x48, "jump_special_left", dx=-1),
    MvtAction(0x49, "jump_special_right", dx=1),
    MvtAction(0x4A, "face_player"),
    MvtAction(0x4B, "face_away_player"),
    MvtAction(0x4C, "lock_facing_direction"),
    MvtAction(0x4D, "unlock_facing_direction"),
    MvtAction(0x4E, "jump_down", dy=1),
    MvtAction(0x4F, "jump_up", dy=-1),
    MvtAction(0x50, "jump_left", dx=-1),
    MvtAction(0x51, "jump_right", dx=1),
    MvtAction(0x52, "jump_in_place_down"),
    MvtAction(0x53, "jump_in_place_up"),
    MvtAction(0x54, "jump_in_place_left"),
    MvtAction(0x55, "jump_in_place_right"),
    MvtAction(0x56, "jump_in_place_down_up"),
    MvtAction(0x57, "jump_in_place_up_down"),
    MvtAction(0x58, "jump_in_place_left_right"),
    MvtAction(0x59, "jump_in_place_right_left"),
    MvtAction(0x5A, "face_original_direction"),
    MvtAction(0x5B, "nurse_joy_bow_down"),
    MvtAction(0x5C, "enable_jump_landing_ground_effect"),
    MvtAction(0x5D, "disable_jump_landing_ground_effect"),
    MvtAction(0x5E, "disable_animation"),
    MvtAction(0x5F, "restore_animation"),
    MvtAction(0x60, "set_invisible"),
    MvtAction(0x61, "set_visible"),
    MvtAction(0x62, "emote_exclamation_mark"),
    MvtAction(0x63, "emote_question_mark"),
    MvtAction(0x64, "emote_x"),
    MvtAction(0x65, "emote_double_excl_mark"),
    MvtAction(0x66, "emote_smile"),
    MvtAction(0x67, "reveal_trainer"),
    MvtAction(0x68, "rock_smash_break"),
    MvtAction(0x69, "cut_tree"),
    MvtAction(0x6A, "set_fixed_priority"),
    MvtAction(0x6B, "clear_fixed_priority"),
    MvtAction(0x6C, "init_affine_anim"),
    MvtAction(0x6D, "clear_affine_anim"),
]
